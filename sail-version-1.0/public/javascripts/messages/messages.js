...
var addInvestmentM = {
	...
	addMessage:function(assetClass) {return "Enter the name or symbol below of the "+assetClass+
        " you would like to add"},
	addManualMessage:function(assetClass) {return "Enter the name and current value of the "+assetClass+
        " you would like to add"},
}

var editInvestment = {
	editTitle:function(assetClass) {return "Edit "+assetClass+" Value"},
	editMessage:function(assetClass) {return "Select the "+assetClass+" you would like to change " +
        "the quantity or value of"},
	noInvMessage:function(assetClass) {return "You have no current "+assetClass+" investments," +
        " please use the menu on the left to add an asset"},
